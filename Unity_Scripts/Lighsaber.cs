...
public class Lighsaber : MonoBehaviour
{
    ...
    [SerializeField] private Text Hittext1;
    [SerializeField] private Text Hittext2;
    [SerializeField]
    ...
    private void OnTriggerExit(Collider other)
    {
        ...
        if (this.gameObject.tag == "Player1")
        {
            ...
            {
                hit++;
                //     Debug.Log("it is true " + hit);
                Hittext1.text = "Score  " + hit;
            }
...
//            Debug.Log("it is true " + hit);
        ...
        _particleSystem.GetComponentsInChildren<ParticleSystem>()[0].Play();
        _particleSystem.GetComponentsInChildren<ParticleSystem>()[1].Play();
